    ...
    items: [
      {
        ...
        reasonText: 'Elevated blood pressure requires provider assessment.',
        urgency: 'URGENT',
        destinationName: 'North District Clinic',
        dueDate: '2026-08-20',
        status: 'CONTACTED',
        ...
        closedAt: null,
        closureReason: null,
        createdByPractitionerName: 'Synthetic Nurse One',
        updatedByPractitionerName: 'Synthetic Nurse One',
        closedByPractitionerName: null,
        statusEventCount: 2,
        followupCount: 1,
        lastFollowupAt: '2026-08-19T09:30:00.000Z',
        sourceRevision: 2,
        lastReceivedAt: '2026-08-19T09:31:00.000Z',
      },
    ],
  },
} satisfies PatientDetail;

export const patientReferralDetail = {
  referral: patientDetail.referralHistory.items[0]!,
  statusHistory: {
    page: 1,
    pageSize: 10,
    totalItems: 2,
    ...
    items: [
      {
        statusEventId: '45000000-0000-4000-8000-000000000002',
        sequenceNumber: 2,
        fromStatus: 'OPEN',
        toStatus: 'CONTACTED',
        changeReason: 'Patient reached by phone',
        changedByPractitionerName: 'Synthetic Nurse One',
        changedAt: '2026-08-19T09:30:00.000Z',
      },
      {
        statusEventId: '45000000-0000-4000-8000-000000000001',
        sequenceNumber: 1,
        fromStatus: null,
        toStatus: 'OPEN',
        changeReason: 'Automatic screening referral',
        changedByPractitionerName: 'Synthetic Nurse One',
        changedAt: '2026-08-18T11:20:00.000Z',
      },
    ],
  },
  followupHistory: {
    ...
    items: [
      {
        followupId: '46000000-0000-4000-8000-000000000001',
        ...
        dateSeen: '2026-08-19',
        reportedOutcome: 'Patient reports provider assessment completed.',
        reportedMedicationsOrAdvice: 'Reduce salt and continue monitoring.',
        nextAction: 'Confirm blood pressure at next visit.',
...
} satisfies PatientReferralDetail;
