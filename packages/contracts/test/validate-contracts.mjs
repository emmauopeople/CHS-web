...
const schemaLocations = Object.freeze({
  ...
  encounteraddendum: 'schemas/sync/v1/encounter-addendum.schema.json',
  encounterreviewflag: 'schemas/sync/v1/encounter-review-flag.schema.json',
  encounterreviewstatus: 'schemas/sync/v1/encounter-review-status.schema.json',
  referral: 'schemas/sync/v1/referral.schema.json',
  referralStatus: 'schemas/sync/v1/referral-status.schema.json',
  referralFollowup: 'schemas/sync/v1/referral-followup.schema.json',
...
const validFixtureCases = Object.freeze([
  ...
  ['syncRequest', 'fixtures/sync/v1/valid/referral-batch-request.json'],
  ['syncRequest', 'fixtures/sync/v1/valid/encounter-history-batch-request.json'],
